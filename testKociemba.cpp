...
unordered_map<int8_t, int8_t> cornerPosForNumber = {{0, 0b110010}, {1, 0b10`0110}, {2, 0b101100}, {3, 0b111000}, {4, 0b010011}, {5, 0b000111}, {6, 0b001101}, {7, 0b011001}};
...
int main()
{
    ...
    // cout << G0_to_G1;
    vector<string> output = alg(G0_to_G1 + solveG2(Execute(c, G0_to_G1)));
    for (auto i : output)
        cout << i << " ";
    // cout << solveG2(c);
    cout << endl
...
// Couldn't solve this --> grwgbyrwbyobbwwyygwrybrgwggobbwyorrwobowooggbryyogyrro

// g++ -O3 -march=native -flto -funroll-loops huh.cpp

// wwogbbygwgwgbryryyrrgowobyborbgobyrywrroywgowrboggybwo